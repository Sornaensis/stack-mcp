...
tools:
  - stack_mcp_set_repo
  - stack_mcp_get_repo
  - stack_mcp_stack_ls_dependencies
  - stack_mcp_stack_ls_snapshots
  - stack_mcp_stack_ls_globals
  - stack_mcp_stack_update
---
...
**Definition of done:** A dependency listing, snapshot query, or update request is complete once the selected tool returns its first result.
...
- `stack_ls_dependencies` inspects project dependencies.
